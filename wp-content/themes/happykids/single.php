										...
										<?php if(have_posts()) :  while(have_posts()) : the_post();
											...
											$tags = get_the_tags();
												...
												<div class="post-entry">
														...
														<?php } elseif ( has_post_thumbnail()) {
															...
															<div class="content-wrapper alignleft">
																...
																<?php 
																	...
																	<img class="pic" src="<?php echo($post_img ? $image[0] : bfi_thumb( $image[0], $f_img_settings)); ?>" alt="<?php the_title(); ?>" />
																<?php } else { ?>																
																	<a class="prettyPhoto kids_picture" title="<?php the_title(); ?>" href="<?php echo esc_url($image[0]); ?>"><img class="pic" src="<?php echo bfi_thumb( $image[0], $f_img_settings); ?>" alt="" /></a>
																<?php } ?>
																</figure>
															</div><!--/ post-thumb-->
														<?php } ?>
													...
													<div class="entry">
														<?php the_content(); ?>
														<?php wp_link_pages( array( 'before' => '<div class="pagenavi">' . __( 'Pages:', 'happykids' ), 'after' => '</div>') ); ?>
													</div><!--/ entry--> 
