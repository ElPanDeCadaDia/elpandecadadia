...
function cws_widget_icon_rendering ($args){
	...
	if (($title_select == 'fa') && (!empty($title_fa))) {
		...
		echo '<div class="widget-icon pic"><img src="' . bfi_thumb( wp_get_attachment_url( $title_img ), array( 'width' => 88 ) ) . '" alt /></div>';
	}
}
