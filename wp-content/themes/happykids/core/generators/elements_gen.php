		...
		function uploader($item){
			...
			if ($medup_val && ($item['preview'] == 'show')){
					if ($preview_height || $preview_width){
						$preview = '<div class="two-column" style="vertical-align:top"><div class="'. $item['id'] .'-preview uploader_preview"><img src="' . bfi_thumb( $medup_val, array('width' => $preview_width, 'height' => $preview_height, 'crop' => true) ) . '" alt="'.$item['name'].'" /></div></div>';
					}else {
