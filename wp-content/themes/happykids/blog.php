						...
						<div class="content-wrapper alignleft">
							<figure>
								<?php if($disable_lightbox) { ?>
									<img class="pic" src="<?php echo bfi_thumb( $image[0], $f_img_settings); ?>" alt="<?php the_title(); ?>" />
								<?php } else { ?>
									<a class="prettyPhoto kids_picture" title="<?php the_title(); ?>" href="<?php echo esc_url($image[0]); ?>"><img class="pic" src="<?php echo bfi_thumb( $image[0], $f_img_settings); ?>" alt="<?php the_title(); ?>" /></a>
								<?php } ?>
							</figure>
						</div><!--/ post-thumb-->
					<?php } ?>
