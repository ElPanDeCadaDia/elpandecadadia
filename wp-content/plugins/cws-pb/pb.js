	...
	function(Y) {
		...
		var onClickorDomReady = function(e) {
			...
			if (!content_wrap.hasClass('cws-active')) {
				...
				content_wrap.removeClass('tmce-active');
				content_wrap.removeClass('html-active');
				content_wrap.addClass('cws-active');
		...
		var onClickTmce_or_Publish = function(e, is_update) {
			...
			if (e.type == 'click') {
				...
				target_tab = Y.one('#wp-content-wrap').hasClass('cws-active') ? 'cwspb' : 'tmce';
			}
